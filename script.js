...
$(function(){
  $("body").css("overflow","hidden").append("<style>@keyframes loadingbar{0%{background-position:0 0}0%{background-position:-1200% 0}}</style><div id=\"bodyloadwrap\" style=\"position:fixed; width:100%;height:100%; top:0; left:0;background:#fff;z-index:1000000;text-align:center;font-family:Georgia,serif;color:#fff\"><div style=\"position:absolute;left:50%;top:38%;margin-left:-145px;width:290px;overflow:hidden;padding-right:2px;animation:loadingbar 80s linear infinite;background:#000 linear-gradient(45deg, #000 0%,#000 25%,#333 25%,#333 50%,#000,50%,#000 75%,#333 75%,#333 100%) 0px 0 repeat;background-size:1.2rem 1.2rem\"\><p style=\"margin:0;height:1.2rem; line-height:1.2rem; top:-2rem;font-size:1rem\">Hello, This is Dongfang.<\/p><div id=\"bodyload\" data-progress=\"0\" style=\"position:absolute;left:0;top:0; height:1.2rem;width:105%;mix-blend-mode:difference;background:#fff;transform:translateX(0) skewX(15deg)\"><\/div><\/div><div style=\"position:absolute;width:100%;bottom:2rem;left:0;color:#000;font-size:.875rem\">Visit <a href=\"https://futurefriendly.gitee.io/designer/\"><u>the mirror website<\/u><\/a> (for slow connections).<\/div><\/div>");
  $("body").queryLoader2({
    barColor: "#000",
    backgroundColor: "#fff",
    percentage: false,
