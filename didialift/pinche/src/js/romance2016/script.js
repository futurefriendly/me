...
$(function() {
    ...
    var shareLink = location.href + '?regfrom=' + _channel;
    ...
    initWxShare(rom_param.wxShareConfig); 
    ...
    if(VARS.IsDiDiBrowser){
        ...
        var entranceConfig = {
            ...
            buttons: [{
                    ...
                    name: "分享到新浪微博",
                    data: $.extend({}, rom_param.shareConfig, {
                        share_content: rom_param.shareConfig.weibo_desc || rom_param.shareConfig.desc
                    }),
                    callback: function() {}
                }, {
