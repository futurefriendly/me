...
$(function() {
    ...
    initWxShare(pink_param.wxShareConfig); 
    ...
    if(VARS.IsDiDiBrowser){
        ...
        var entranceConfig = {
            ...
            buttons: [{
                    ...
                    name: "分享到新浪微博",
                    data: $.extend({}, pink_param.shareConfig, {
                        share_content: pink_param.shareConfig.weibo_desc || pink_param.shareConfig.desc
                    }),
                    callback: function() {}
                }, {
