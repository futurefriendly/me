	...
	if ( !($.SyntaxHighlighter||false) ) {
		$.SyntaxHighlighter = {
			...
			'config': {
				 ...
				 */
				'prettifyBaseUrl': false ? 'http://static.didialift.com/pinche/js/jquery-syntaxhighlighter/prettify' : 'http://static.didialift.com/pinche/js/jquery-syntaxhighlighter/prettify',

				/**
				 * The baseUrl to load our Syntax Highlighter from.
				 * This is used to load in the stylesheet and additional themes.
				 */
				'baseUrl': false ? 'http://static.didialift.com/pinche/js/jquery-syntaxhighlighter' : 'http://static.didialift.com/pinche/js/jquery-syntaxhighlighter'
			},
