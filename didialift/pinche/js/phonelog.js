define("__phonelog",function(){
    ...
    $output_container_minimizer.addEventListener('click', function () {
    ...
    var key_color = 'rgb(243,130,0)';
    var string_color = 'green';
    ...
    console.log = function () {
        ...
        var output = [];
        [].slice.call(arguments, 0).concat('<hr/>').forEach(function(val, key){
            val = processOutput(val, 0);
            if($.isArray(val)){
