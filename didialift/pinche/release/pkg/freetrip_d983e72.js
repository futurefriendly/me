define('page/freetrip/main.js', function(require, exports, module){ /**
 *
 *   @description: 页面播放器生成
 *
 *   @version    : 1.0.1
...
var mis2 = /MI 2S/i.test(navigator.userAgent);
var init = function() {
	ddplayer.ready(function(Player) {
		...
		var playerMaker = {
			param: {
				...
				shareConfig: {
					share_url: shareLink,                   
			        share_img_url: 'http://static.xiaojukeji.com/pinche/release/page/freetrip/images/share_acd1742.png',                      
			        share_icon_url: 'http://static.xiaojukeji.com/pinche/release/page/freetrip/images/share_acd1742.png',                      
			        share_title: '美少女亲授顺风车免单秘笈，你不来学几招？',       
			        share_content: 'SNH48十大国民美少女亲授滴滴顺风车免单秘笈，你不来学几招？',
			        weibo_desc: 'SNH48十大国民美少女亲授滴滴顺风车免单秘笈，你不来学几招？-滴滴 (来自@滴滴顺风车) http://t.cn/RyVFtQ4'  
				}
			},
			model: {
				//播放器对象
		...
		c.init = function() {
			...
			if (p.init()) {
				...
				$(window).bind('load',function(){
					_send('sfc-video-151229_index_sw',null,true);
				});
		...
		c.eventInit = function() {
			...
			m.player.on('play', function(){
				...
				if(!p.isPlayed){
					...
					//改变标识为
					p.isPlayed = true;
					_send('sfc-video-151229_index_ck',null,true);
				}
