...
function showQRCode(text, cfg) {
    var _cfg = cfg || {};

    var dotsize = _cfg.dotsize || 5; // size of box drawn on canvas
    var padding = _cfg.padding || 10; // (white area around your QRCode)
    var black = _cfg.black || "rgb(0,0,0)";
    var white = _cfg.white || "rgb(255,255,255)";
    var QRCodeVersion = _cfg.QRCodeVersion || 15; // 1-40 see http://www.denso-wave.com/qrcode/qrgene2-e.html
