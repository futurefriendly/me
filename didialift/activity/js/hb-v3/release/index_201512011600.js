        ...
        base.ajax({
            ...
            succFunc: function(d) {
                ...
                if (d.pageno != "3") {
                    ...
                    location.href = "http://static.diditaxi.com.cn/activity/pages/serverbusy/serverbusy.html?datatype=driver&errmsg=[" + d.errno + "] " + d.errmsg + '&phone=' + globalPhone;
                }
            },
            failFunc: function() {
    ...
    (function init() {
        ...
        */
        function setWeiboShare() {
            App.trigger('setBrowserTitle', '滴滴打车');
