/**
 * 生成对话框dd.dialog rely on dd.common.css&dd.ui.css
 */
    ...
    var util = {
        ...
        genIcon: function(icon) {
            ...
            var w = icon.width || "8px",
                h = icon.height || "36px",
                url = icon.url || "/static/webapp/src/images/i-plaint.png",
    ...
    dd.dialog.loading = function(cfg) {
        ...
        dialog = Dialog({
            ...
            icon: (cfg && cfg.icon) || {
                width: "40px",
                height: "40px",
                url: "/static/webapp/src/images/loading_2.gif"
            },
            tip: {
                txt: opts.text || "正在加载",
                color: "#fff",
    ...
    dd.dialog.flatLoading = function(cfg) {
        ...
        dialog = Dialog({
            ...
            icon: (cfg && cfg.icon) || {
                width: "43px",
                height: "34px",
                url: "/static/webapp/src/images/i-loading.gif"
            },
            tip: {
                txt: opts.text || "",
                color: "#666",
    ...
    */
    dd.dialog.tip = function(cfg) {
        ...
        dialog = Dialog({
            ...
            icon: _cfg.icon || {
                url: "/static/webapp/src/images/i-tip.png",
                width: "45px",
                height: "45px"
            },
            tip: {
