...
function switchlang(bl){
  ...
  var lang = {
    ...
    // la_94 : ['2018年8月','2018'],
    la_95 : ['版权 2018-2021 \&copy\;futurefriendly\.cn\, 保留所有权利，包括以任何形式复制本网站或其中部分内容的权利。有关信息，请咨询内容发布者。','Copyright 2018-2021 \&copy\;futurefriendly\.cn\, all rights reserved\, including the right to reproduce this site or portions thereof in any form whatsoever\. For information\, address the content publisher\.'],
