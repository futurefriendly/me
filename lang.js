...
function switchlang(bl){
  ...
  var lang = {
    ...
    la_12 : ['你好！欢迎并感谢莅临本网页。我是一名中文和互联网交叉背景的产品交互设计师，常住北京。先后在北京师范大学、香港教育大学获得学士及硕士学位（汉语言文学、中文教育）。9年互联网从业经验，曾在腾讯、滴滴出行等公司任网页制作工程师和交互设计师。','Welcome! Here is a craftsman living in Beijing with an X-shaped skill background\. He holds a Master of Arts degree from the Education University of Hong Kong in Chinese Studies (Language Education) which completed with distinction\. As a UX designer passionate about Web design and writing\, he used to work for Tencent and DiDi Chuxing Group and has 9 years of industry experience\.'],
    ...
    la_76 : ['\<a target\=\"_blank\" href\=\"\.\/assets\/cdm_cn\.svg\" class\=\"btn2\"\>在新窗口中查看大图\<\/a\>','\<a target\=\"_blank\" href\=\"\.\/assets\/cdm\.svg\" class\=\"btn2\"\>View it in a new window\<\/a\> \<a target=\"_blank\" href=\"\.\/resume\.pdf\" class=\"btn2\"\>Download my resume\<\/a\>'],
