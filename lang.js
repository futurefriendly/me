...
function switchlang(bl){
  ...
  var lang = {
    ...
    la_111 : ['——如果你还记得腾讯微博，可能也记得官方服务号“腾讯薇薇”。蒲公英Logo正是出于薇薇之手。起初，腾讯微博的slogan是“与其在别处仰望，不如在这里并肩”。这个slogan是针对新浪微博的以大V为中心，忽视草根声音而提出。后改为“你的心声，世界的回声”，意为草根的声音也能在微博平台得到回应。','— If you still remember Tencent Weibo \(t\.qq\.com\)\, you may also remember an official service account \"Tencent WeiWei\" that owns a young lady\'s avatar\. Actually\, WeiWei is a visual designer of Tencent\, the Dandelion Logo of that product is designed by her\. In the beginning\, the slogan of Tencent Weibo was \"It\’s better to be together here than to envy others elsewhere\.\" Tencent Weibo believes that Sina Weibo pays too much attention to the key opinion leaders and ignores the voice of the general public\, so this slogan conveys the meaning that Tencent pays more attention to ordinary users\. Later\, Tencent Weibo\'s slogan was changed to \"Your voice\, the echo of the world\"\. This means that the voices of ordinary people can also be widely spread and responded\.'],
    la_112 : ['春运暖心日历：','SPRING FESTIVAL TRANSPORTATION CALENDAR: '],
    la_113 : ['作为一个和单向空间合作的运营页面，为了吸引用户互动，我们在产品中加入了一个对联游戏。除此以外，为了配合合作方的产品风格，我们在这个页面中设计了一些微动效。','This is a marketing activity webpage which cooperates with One-Way Street Bookstore\. It can be accessed via a link in the Divide Mobile Client\. In order to attract users\, we added a traditional Chinese Couplet game into this page\.']
  };
  var thislang = '';
