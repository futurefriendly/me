...
function switchlang(bl){
  ...
  var lang = {
    ...
    la_23 : ['2015年后，设计体系取代了设计规范，渐渐成为了更有效率的设计实践方式。一些组织，如\<a href=\"lightingdesignsystem\.com\" target=\"_blank\"\>Salesforce\<\/a\>，做出了设计体系的最佳实践。设计体系将内容与可访问性等元素纳入了设计需求的一部分，将设计规范和组件库统一了起来。结合之前我在腾讯微博维护Web设计规范的经验和Brad Frost的Atomic Design模块化设计思想，我们制作了这份顺风车的设计体系。','Since 2015\, The design system replaced the guideline\, gradually became a more efficient design practice\. Some organizations\, such as \<a href=\"lightingdesignsystem\.com\" target=\"_blank\"\>Salesforce\<\/a\>, have done best practices in that way\. The design system incorporates elements such as content strategy and accessibility into the design requirements and unifies the design guideline and component library\. Rely on my previous experience of Tencent Weibo\'s Web design guideline\, and Brad Frost\'s Atomic Design philosophy\, we created this design system of DiDi Hitch\.'],
    ...
    la_87 : ['渐进增强：跨平台用户体验设计','JIANJINZENGQIANG: KUAPINGTAI YONGHU TIYAN SHEJI'],
    la_88 : ['小','A'],
    la_89 : ['中','A'],
    la_90 : ['大','A'],
