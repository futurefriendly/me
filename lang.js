...
function switchlang(bl){
  ...
  var lang = {
    ...
    la_12 : ['你好！欢迎并感谢莅临本网页。我是一名中文教育和互联网交叉背景的产品交互设计师，常住北京。曾供职腾讯、滴滴出行等公司。','Welcome! Here is a craftsman living in Beijing with an X-shaped skill background\. As a professional UX designer who is familiar with Web design and technical writing\, he used to work for Tencent and DiDi Chuxing Group\.'],
