...
function switchlang(bl){
  ...
  var lang = {
    ...
    la_12 : ['你好！欢迎并感谢莅临本网页。我叫东方，常住北京，中文和互联网交叉背景。香港教育大学文学硕士。曾在腾讯、滴滴出行等公司任交互设计师。','Welcome\! Here is a craftsman living in Beijing with an X-shaped skill background\. On the one hand\, Dongfang hold a Master of Arts degree (Dean\'s Honour) from the Education University of Hong Kong in Chinese Studies\. On the other hand\, as a user experience designer or developer passionate about Web design and writing\, he used to work for Tencent and DiDi Chuxing Group for years\.'],
