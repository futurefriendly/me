...
function switchlang(bl){
  ...
  var lang = {
    ...
    la_14 : ['一、为基于iOS或Android平台的移动应用做交互设计。','2) Interaction design for mobile application\;'],
    la_15 : ['二、响应式设计网站的Web设计。','1) Design consultation of making a responsive website\;'],
