    ...
    window.initWxShare = function(shareConfig) {
        ...
        $.ajax({
            ...
            error: function(){
                ...
                $.ajax({
                    url: "https://wap.didialift.com/pinche/wxApi/getJsSdkConfig?url="
    ...
    function share_config(shareConfig) {
        ...
        var share_obj = shareConfig 
                || {
                    ...
                    link: location.href,
                    imgUrl: "https://static.xiaojukeji.com/pinche/images/sfx1508/yzbb.jpg"
                };
...
$(function(e) {
    ...
    function initDidiShare(config) {
        ...
        var entranceConfig = {
                entrance: {
                    icon: 'https://static.diditaxi.com.cn/webapp/images/driver.png'
                },
